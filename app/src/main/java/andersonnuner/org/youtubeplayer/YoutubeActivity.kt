...
const val YOUTUBE_VIDEO_ID = "oLsmFg90Pm0"
const val YOUTUBE_PLAYLIST = "PLXtTjtWmQhg1sBPGWFRlD5saOD6sqAH8C"
...
//        layout.addView(button1)
    ...
    override fun onInitializationSuccess(
        ...
        Log.d(TAG, "onInicializationSuccess: provider is ${provider?.javaClass}")
        Log.d(TAG, "onInicializationSuccess: youTubePlayer is ${youTubePlayer?.javaClass}")
    ...
    private val playbackEventListener = object : YouTubePlayer.PlaybackEventListener {
        override fun onPlaying() {
            Toast.makeText(this@YoutubeActivity, "Good video is playing ok", Toast.LENGTH_LONG)
                .show()
        }
    ...
    private val playerStateChangeListener = object : YouTubePlayer.PlayerStateChangeListener {
        ...
        override fun onVideoEnded() {
            Toast.makeText(
                this@YoutubeActivity, "" +
                        "Congrtatulations! You've completed another video", Toast.LENGTH_LONG
            ).show()
        }
